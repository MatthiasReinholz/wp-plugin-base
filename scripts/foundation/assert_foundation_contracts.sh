...
assert_file_contains_literal "$ROOT_DIR/.github/workflows/scorecard.yml" 'github/codeql-action/upload-sarif@68bde559dea0fdcac2102bfdf6230c5f70eb485e' "Scorecard workflow must pin upload-sarif to the reviewed SHA."
...
assert_file_contains_literal "$ROOT_DIR/templates/child/admin-ui-pack-seed-common/includes/admin-ui/bootstrap.php" "'parent_slug'            => 'options-general.php'" "Managed admin UI seed must default to the WordPress Settings submenu."
assert_file_contains_literal "$ROOT_DIR/templates/child/admin-ui-pack/lib/wp-plugin-base/admin-ui/class-wp-plugin-base-admin-ui-loader.php" 'add_submenu_page(' "Managed admin UI loader must support submenu registration."

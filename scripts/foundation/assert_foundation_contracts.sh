...
assert_file_contains_literal "$ROOT_DIR/.github/workflows/release.yml" 'missing Sigstore asset' "Reusable manual release workflow must verify the published GitHub release and assets."

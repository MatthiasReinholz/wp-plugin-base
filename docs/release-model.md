...
- `release.yml` remains available as a manual recovery path for an already existing tag and uses GitHub release repair mode when the release already exists
